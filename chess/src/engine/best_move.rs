...
mod tests {
    ...
    fn test_pgn1_no_illegal_null_move() {
        ...
        // UCI-encoded moves:
        let moves = [
            "a2a4", "h5h4", "g3h4", "d6h2", "h4h5", "h2d6",
            "e3e4", "e6e5", "a4a5", "e8f8", "c3c4", "a8e8",
            "c4c5", "d6e7", "d1c2", "e8a8",
        ];
    ...
    fn test_pgn2_no_illegal_null_move() {
        ...
        // UCI-encoded moves:
        let moves = [
            "b1d2", "c7c5", "g1h2", "g8h7", "d2b3", "g7g5",
            "a1b1", "a7a5", "b1a1", "a5a4", "b3d2", "d8c7",
            "c3c4", "b5c6", "c2c3", "b7b5", "f1e1", "b5b4",
            "c3c2", "a8a7", "e1e2", "a7b7", "a1c1", "a4a3",
            "c1b1", "g5g4", "h3g4", "f6g4", "h2g3", "g4e3",
            "e2e3", "b7g8", "g3h2", "h7h5", "e3e2", "h5h4",
            "b3d2", "g8g7", "c2d2", "f6e7",
            "d2e3", "b6e3", "h2h3", "e7d7", "h3h2", "d7e6",
            "e2c2", "c6c2", "d2b3", "a4a3", "b3c1",
        ];
        let mut board = Chess::from_fen(fen);
        apply_moves(&mut board, &moves);
